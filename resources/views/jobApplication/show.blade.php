                 ...
                 <dl class="row">
                   ...
                   <dt class="col-sm-3"><span class="h6 text-sm mb-0">{{ __('Cover Letter') }}:</span></dt>
                    ...
                    <div class='rating-stars text-right'>
                        <ul id='stars'>
                            <li class='star {{(in_array($jobApplication->rating,[1,2,3,4,5])==true)?'selected':''}}' data-bs-toggle="tooltip"   data-bs-original-title="Deficiente" data-value='1'>
                            <i class='fa fa-star fa-fw'></i>
                            </li>
                            <li class='star {{(in_array($jobApplication->rating,[2,3,4,5])==true)?'selected':''}}' data-bs-toggle="tooltip"   data-bs-original-title='Puede mejorar' data-value='2'>
                            <i class='fa fa-star fa-fw'></i>
                            </li>
                         <li class='star {{(in_array($jobApplication->rating,[3,4,5])==true)?'selected':''}}' data-bs-toggle="tooltip"   data-bs-original-title='Bien' data-value='3'>
                            <i class='fa fa-star fa-fw'></i>
                            </li>
                            ...
                            <li class='star {{(in_array($jobApplication->rating,[5])==true)?'selected':''}}' data-bs-toggle="tooltip"   data-bs-original-title='WOW ES UN JUSTIN COMBINADO CON ISIS!!!' data-value='5'>
                            <i class='fa fa-star fa-fw'></i>
                            </li>
                        </ul>
                    </div>
