...
<head>
    ...
    <title>
        {{ !empty($companySettings['title_text']) ? $companySettings['title_text']->value : config('app.name', 'RRHH') }}
        - {{ __('Career') }}</title>
            ...
            <div class="container pt-5">
                <div class="row row-grid justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <h2 class="h1 mb-4">{{ __('Ofertas de empleo') }}</h2>
                        <p class="lead lh-180">{{ __('Trabajar aquí. Encuentra el trabajo de ensueño que siempre has querido ..') }}</p>
        ...
        <section class="slice slice-lg bg-section-secondary">
            ...
            <div class="container">
                <div class="mb-5 text-center">
                    <h3 class=" mt-4">{{ __('Ayudamos a las empresas a crecer') }}</h3>
                    <div class="fluid-paragraph mt-3">
                        <p class="lead lh-180 ">
                            {{ __('Siempre buscando mejores maneras de hacer las cosas, innovar y ayudar a las personas a lograr sus objetivos.') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="row align-items-center justify-content-md-between py-4 mt-4 delimiter-top">
                    <div class="col-md-6">
                        <div class="copyright text-sm font-weight-bold text-center text-md-left">
                            {{ !empty($companySettings['footer_text']) ? $companySettings['footer_text']->value : 'RRHH' }}
                        </div>
                    </div>
                    <div class="col-md-6">
