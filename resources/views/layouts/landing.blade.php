...
<head>
    {{-- <title>{{ __('RRHH') }}</title> --}}
    <title>
        {{ App\Models\Utility::getValByName('title_text') ? App\Models\Utility::getValByName('title_text') : config('app.name', 'HHRR ') }}
    </title>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="{{ route('login') }}" class="btn btn-light me-2"><i class="far fa-eye me-2"></i>
                            Demo</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    ...
                    {{-- <p class="text-body"> {{ __('Copyright') }} &copy;
                        {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'Datasys') }}
                        {{ date('Y') }} </p> --}}
                    <p class="text-body"> {{ __('Copyright') }}
                        {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'RRHH SaaS') }}
                        {{ date('Y') }} | Design By DStic CR </p>
                </div>
            </div>
        </div>
