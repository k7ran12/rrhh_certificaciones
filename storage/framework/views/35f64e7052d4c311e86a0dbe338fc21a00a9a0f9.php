                        ...
                        <div class="row">
                            <div class="col-6">
                                <div style="margin-top: 20px;">
                                    <img width="" src="<?php echo e($contract->company_signature); ?>" >
                                </div>
                                <div>
                            ...
                            <div class="col-6 text-end">
                                <div style="margin-bottom: 20px;">
                                    <img width="" src="<?php echo e($contract->employee_signature); ?>" >
                                </div>
                                <div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contractheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CRISTIAN\Downloads\RRHH_CERTIFICACIONES\resources\views/contracts/contract_view.blade.php ENDPATH**/ ?>