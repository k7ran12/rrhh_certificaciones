                                                        ...
                                                        <div class="logo-content mt-4  setting-logo">
                                                            ...
                                                            <a href="<?php echo e($logo . (isset($company_logo_light) && !empty($company_logo_light) ? $company_logo_light : 'light_logo.png')); ?>"
                                                                ...
                                                                <img id="image1" alt="your image"
                                                                    src="<?php echo e($logo . (isset($company_logo_light) && !empty($company_logo_light) ? $company_logo_light : 'light_logo.png')); ?>"
                                                                    width="150px"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CRISTIAN\Downloads\RRHH_CERTIFICACIONES\resources\views/setting/company_settings.blade.php ENDPATH**/ ?>