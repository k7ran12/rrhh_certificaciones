    ...
    <nav class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light bg-white" id="navbar-main">
        <div class="container px-lg-0">
            <a class="navbar-brand mr-lg-5" href="#">
                <img class="hweb" alt="Image placeholder" src="<?php echo e($logo.'/'.(isset($companySettings['company_logo']) && !empty($companySettings['company_logo'])?$companySettings['company_logo']->value:'logo-dark.png')); ?>" id="navbar-logo" style="height: 50px;">
            </a>
...
<?php /**PATH /home/xperthost/hr.xperthost.es/resources/views/job/requirement.blade.php ENDPATH**/ ?>