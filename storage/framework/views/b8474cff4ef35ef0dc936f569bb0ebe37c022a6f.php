                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <label class="radio-inline">
                                                <?php echo Form::radio('has_vehicle', 'si', old('has_vehicle') === 'si'); ?> Sí
                                            </label>
                                            <label class="radio-inline">
                                                <?php echo Form::radio('has_vehicle', 'no', old('has_vehicle') === 'no'); ?> No
                                            </label>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\CRISTIAN\Downloads\RRHH_CERTIFICACIONES\resources\views/employee/create.blade.php ENDPATH**/ ?>