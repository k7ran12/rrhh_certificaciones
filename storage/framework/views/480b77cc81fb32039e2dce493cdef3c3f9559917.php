...
<head>
    ...
    <title>
        <?php echo e(App\Models\Utility::getValByName('title_text') ? App\Models\Utility::getValByName('title_text') : config('app.name', 'HHRR ')); ?>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    ...
                    <p class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.6s">
                        Recursos humanos Datasys.
                    </p>
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-light me-2"><i class="far fa-eye me-2"></i>
                            Demo</a>
                        <a href="https://codecanyon.net/item/hrmgo-hrm-and-payroll-tool/25982864"
                            class="btn btn-outline-light" target="_blank"><i class="fas fa-shopping-cart me-2"></i>Comprar</a>
                    </div>
                </div>
                <div class="col-sm-5">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                <div class="col-sm-4">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="#" class="btn btn-primary" target="_blank"><i class="fas fa-shopping-cart me-2"></i>Comprar</a>
                    </div>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    ...
                    <p class="text-body"> <?php echo e(__('Copyright')); ?>
                        ...
                        <?php echo e(Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'RRHH SaaS')); ?>

                        <?php echo e(date('Y')); ?> | Design By DStic CR </p>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\CRISTIAN\Downloads\RRHH_CERTIFICACIONES\resources\views/layouts/landing.blade.php ENDPATH**/ ?>