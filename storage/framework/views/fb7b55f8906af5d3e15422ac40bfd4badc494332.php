...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-xl-6 img-card-side">
            <div class="auth-img-content">
                ...
                <h3 class="text-white mb-4 mt-5"> <?php echo e(__('“Sistema de Gestion de Recursos Humanos Datasys”')); ?></h3>
                <p class="text-white"> <?php echo e(__('Sistema de Gestion de Recursos Humanos.')); ?></p>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xperthost/hr.xperthost.es/resources/views/auth/login.blade.php ENDPATH**/ ?>