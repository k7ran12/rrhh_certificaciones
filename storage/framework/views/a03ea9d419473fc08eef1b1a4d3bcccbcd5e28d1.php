...
<style type="text/css">
    .m-list-active, .m-list-active:hover, .m-list-active:focus {
    background:linear-gradient(141.55deg, rgba(104, 94, 229, 0) 3.46%, #B8020A 99.86%), #c10009 !important;
}
.mc-sender p {
    background: linear-gradient(141.55deg, rgba(104, 94, 229, 0) 3.46%, #B8020A 99.86%), #c10009 !important;
}
...
.messenger-favorites div.avatar {
    box-shadow: 0px 0px 0px 2px #c10009 !important;
}
.messenger-listView-tabs a, .messenger-listView-tabs a:hover, .messenger-listView-tabs a:focus {
    color: linear-gradient(141.55deg, rgba(104, 94, 229, 0) 3.46%, #B8020A 99.86%), #c10009 !important;
}
.m-header svg {
    color: #c10009 !important;
}
.active-tab {
    border-bottom: 2px solid  #c10009 !important;
}
.messenger-infoView nav a {
...
<?php endif; ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xperthost/hr.xperthost.es/resources/views/vendor/Chatify/pages/app.blade.php ENDPATH**/ ?>