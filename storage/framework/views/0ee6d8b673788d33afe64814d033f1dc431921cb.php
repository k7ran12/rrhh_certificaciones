...
<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Designation')): ?>
        <a href="#" data-url="<?php echo e(route('awardtype.create')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Create Award Type')); ?>" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Award Type')): ?>
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                    data-url="<?php echo e(URL::to('awardtype/' . $awardtype->id . '/edit')); ?>"
                                                    data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title=""
                                                    data-title="<?php echo e(__('Edit Award Type')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xperthost/hr.xperthost.es/resources/views/awardtype/index.blade.php ENDPATH**/ ?>