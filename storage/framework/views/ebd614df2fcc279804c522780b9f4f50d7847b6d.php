            ...
            <div class="card-body">
                ...
                <h5 class="h4">
                    <div class="d-flex align-items-center" data-toggle="tooltip" data-placement="right"
                        ...
                        ?>
                        <a href="<?php echo e(!empty($jobApplication->profile) ?($profiles . $jobApplication->profile) : $logo."avatar.png"); ?>" target="_blank" class="avatar rounded-circle avatar-sm">
            ...
            <div class="card-header" style="height: 400px">
                 <dl class="row">
                    ...
                    <?php if(!empty($jobApplication->address)): ?>
                        ...
                        <dd class="col-sm-9"><span class="text-sm"><?php echo e($jobApplication->address); ?></span>
                        </dd>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <?php if(!empty($jobApplication->zip_code)): ?>
                        <dt class="col-sm-3"><span class="h6 text-sm mb-0"><?php echo e(__('Zip Code')); ?></span></dt>
                        <dd class="col-sm-9"><span class="text-sm"><?php echo e($jobApplication->zip_code); ?></span>
                        </dd>
                    <?php endif; ?>
                    ...
                    <dd class="col-sm-9">
                        ...
                        <?php if(!empty($jobApplication->resume)): ?>
                            <span class="text-sm action-btn bg-primary ms-2">
                                <a href="<?php echo e($resumes . '/' . $jobApplication->resume); ?>"
                            ...
                            <div class="action-btn bg-secondary ms-2">
                                <a class="mx-3 btn btn-sm align-items-center" href="<?php echo e($resumes . '/' . $jobApplication->resume); ?>" target="_blank"  >
                   ...
                   <dt class="col-sm-3"><span class="h6 text-sm mb-0"><?php echo e(__('Cover Letter')); ?>:</span></dt>
                    ...
                    <div class='rating-stars text-right'>
                        <ul id='stars'>
                            <li class='star <?php echo e((in_array($jobApplication->rating,[1,2,3,4,5])==true)?'selected':''); ?>' data-bs-toggle="tooltip"   data-bs-original-title="Deficiente" data-value='1'>
                            <i class='fa fa-star fa-fw'></i>
                            </li>
                            <li class='star <?php echo e((in_array($jobApplication->rating,[2,3,4,5])==true)?'selected':''); ?>' data-bs-toggle="tooltip"   data-bs-original-title='Puede mejorar' data-value='2'>
                            <i class='fa fa-star fa-fw'></i>
                            </li>
                         <li class='star <?php echo e((in_array($jobApplication->rating,[3,4,5])==true)?'selected':''); ?>' data-bs-toggle="tooltip"   data-bs-original-title='Bien' data-value='3'>
                            <i class='fa fa-star fa-fw'></i>
                            </li>
                            <li class='star <?php echo e((in_array($jobApplication->rating,[4,5])==true)?'selected':''); ?>' data-bs-toggle="tooltip"   data-bs-original-title='Excelente' data-value='4'>
                            <i class='fa fa-star fa-fw'></i>
                            </li>
                            <li class='star <?php echo e((in_array($jobApplication->rating,[5])==true)?'selected':''); ?>' data-bs-toggle="tooltip"   data-bs-original-title='WOW ES UN JUSTIN COMBINADO CON ISIS!!!' data-value='5'>
                            <i class='fa fa-star fa-fw'></i>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col text-end">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Interview Schedule')): ?>
                            <a  data-url="<?php echo e(route('interview-schedule.create', $jobApplication->id)); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xperthost/hr.xperthost.es/resources/views/jobApplication/show.blade.php ENDPATH**/ ?>